...
import ControlPanelSec from "../components/ControlPanelSec";
...
export default function Home() {
  ...
  if (loading) {
    return (
      <div className={`flex h-screen bg-hostinger-Dark-blue/5 w-screen justify-center items-center`}>
        <Head>
  ...
  return (
    <div className="bg-slate-200">
      ...
      <main className="font-['Nunito'] max-w-[95rem] bg-white mx-auto">
        ...
        {/* Banner */}
        <Navbar />
        <section className="max-h-screen mb-5">
          <Banner />
        </section>
        {/* Trust */}
        <Trust />
